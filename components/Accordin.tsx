...
const items = [
  {
    ...
    content: "Таны захиалга 5-12 хоног ирнэ. Барааны онцлогоос хамааран захиалга ирэх хугацаа өөрчлөгдөж болохыг анхаарна уу. "
  },
  {
    id: 2,
    icon: Package,
    trigger: "Хүргэлт үнэтэй юу?",
    content: "Хүргэлт 100,000₮-с дээш худалдан авалтанд үнэгүй."
  },
  {
    id: 3,
    icon: Car,
    trigger: "Хөдөө орон нутагт хүргэх үү?",
    content: "Таны захиалга ирмэгц бид хөдөө орон нутгийн унаанд үнэгүй тавьж өгнө."
  }, 
  {
    id: 4,
    icon: RotateCcw,
